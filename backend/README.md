...
## Project Structure
    ...
    ├── deployement_test_de_29357  # Django project configurations
...
1. Clone this repo and `cd deployement_test_de_29357`
...
2. Clone this repo and `cd deployement_test_de_29357`
